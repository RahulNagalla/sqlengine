	...
	def colerror():
			for i in columnNames:
				if i not in dictionary[tableNames[0]]:
					H="Error"+":"+" "+"Column"+" "+i+" "+"not present"
					sys.exit(H)

	colerror()
		# if i in dictionary[tableNames[0]]:
		# 	if i in dictionary[tableNames[1]]:
		# 			H="Error"+":"+" "+"Column"+" "+i+" "+"not present"
		# 			sys.exit(H)
...
def aggregate(func,columnName,tableName,dictionary):
	...
	if columnName == '*':
		G="Error"+":"+" "+"Column"+" "+columnName+" "+"not present"
		sys.exit(G)
	if columnName not in dictionary[tableName]:
		F="Error"+":"+" "+"Column"+" "+columnName+" "+"not present"
		sys.exit(F)
...
def join(columnNames,tableNames,dictionary):
	...
	# for i in columnNames[0]:
	# 	for j in columnNames[1]:
	# 		if i==j:
	# 			H="Error"+":"+" "+"Column"+" "+i+" "+"not present"
	# 			sys.exit(H)
